...
const CustomeizeProducts = () => {
  return (
    <div className="flex flex-col gap-6">
      ...
      <ul className="flex items-center gap-3">
        <li className="ring-1 ring-cartRed text-cartRed rounded-md py-1 px-4 text-sm cursor-pointer">Small</li>
        <li className="ring-1 ring-cartRed text-white bg-cartRed rounded-md py-1 px-4 text-sm cursor-pointer">Medium</li>
