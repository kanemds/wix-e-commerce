    ...
    <div className="py-24 px-4 md:px-8 lg:px-16 xl:32 2xl:px-64 bg-gray-100 text-sm mt-24">
      ...
      <div className="flex flex-col md:flex-row justify-center gap-24">
        ...
        <div className="w-full md:w-1/2 lg:w-1/4 flex flex-col gap-8">
          <Link href="/">
            <div className="text-2xl tracking-wide">STK solution</div>
          </Link>
          <p>Vancouver,BC,Canada</p>
          <span className="font-semibold">stksolution.inc@outlook.com</span>
      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-8 mt-16">
        <div className="">
          &copy; {currentYear} SKT solution
        </div>
        <div className="flex flex-col gap-8 md:flex-row">
          <div >
            <span className="text-gray-500 mr-4">Language</span>
            <span className="font-medium">B.C Canada | English</span>
          </div>
          <div className="">
